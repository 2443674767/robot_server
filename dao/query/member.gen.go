...
func newMember(db *gorm.DB, opts ...gen.DOOption) member {
	...
	_member.TenantID = field.NewInt32(tableName, "tenant_id")
	...
	_member.Level = field.NewInt8(tableName, "level")
	_member.Sex = field.NewInt8(tableName, "sex")
	_member.Birthday = field.NewTime(tableName, "birthday")
	_member.Money = field.NewFloat64(tableName, "money")
	_member.Score = field.NewInt32(tableName, "score")
	_member.Successions = field.NewInt32(tableName, "successions")
	_member.Maxsuccessions = field.NewInt32(tableName, "maxsuccessions")
	_member.Prevtime = field.NewInt64(tableName, "prevtime")
	_member.Logintime = field.NewInt64(tableName, "logintime")
	_member.Loginip = field.NewString(tableName, "loginip")
	_member.Loginfailure = field.NewInt8(tableName, "loginfailure")
...
type member struct {
	...
	Level          field.Int8    // 等级
	Sex            field.Int8    // 性别:1=男性,2=女性,0=未知
	Birthday       field.Time    // 出生日期
	Money          field.Float64 // 余额
	Score          field.Int32   // 积分
	Successions    field.Int32   // 连续登录天数
	Maxsuccessions field.Int32   // 最大连续登录天数
	Prevtime       field.Int64   // 上次登录时间
	Logintime      field.Int64   // 登录时间
	Loginip        field.String  // 登录IP
	Loginfailure   field.Int8    // 失败次数
...
func (m *member) updateTableName(table string) *member {
	...
	m.TenantID = field.NewInt32(table, "tenant_id")
	...
	m.Level = field.NewInt8(table, "level")
	...
	m.Successions = field.NewInt32(table, "successions")
	m.Maxsuccessions = field.NewInt32(table, "maxsuccessions")
	m.Prevtime = field.NewInt64(table, "prevtime")
	m.Logintime = field.NewInt64(table, "logintime")
	m.Loginip = field.NewString(table, "loginip")
	m.Loginfailure = field.NewInt8(table, "loginfailure")
...
func (m *member) fillFieldMap() {
	...
	m.fieldMap["successions"] = m.Successions
	m.fieldMap["maxsuccessions"] = m.Maxsuccessions
	m.fieldMap["prevtime"] = m.Prevtime
	m.fieldMap["logintime"] = m.Logintime
	m.fieldMap["loginip"] = m.Loginip
	m.fieldMap["loginfailure"] = m.Loginfailure
