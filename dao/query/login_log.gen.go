...
func newLoginLog(db *gorm.DB, opts ...gen.DOOption) loginLog {
	...
	_loginLog.TenantID = field.NewInt32(tableName, "tenant_id")
	_loginLog.AccountID = field.NewInt64(tableName, "account_id")
	_loginLog.Type = field.NewString(tableName, "type")
	_loginLog.UID = field.NewInt64(tableName, "uid")
	_loginLog.Username = field.NewString(tableName, "username")
	_loginLog.IP = field.NewString(tableName, "ip")
	_loginLog.Address = field.NewString(tableName, "address")
	_loginLog.Des = field.NewString(tableName, "des")
	_loginLog.Os = field.NewString(tableName, "os")
	_loginLog.Browser = field.NewString(tableName, "browser")
	_loginLog.ErrorMsg = field.NewString(tableName, "error_msg")
	_loginLog.Status = field.NewInt8(tableName, "status")
...
type loginLog struct {
	...
	ErrorMsg  field.String // 登录失败原因
	Status    field.Int8   // 状态:0=成功,1=失败
...
func (l *loginLog) updateTableName(table string) *loginLog {
	...
	l.TenantID = field.NewInt32(table, "tenant_id")
	l.AccountID = field.NewInt64(table, "account_id")
	...
	l.Des = field.NewString(table, "des")
	l.Os = field.NewString(table, "os")
	l.Browser = field.NewString(table, "browser")
	l.ErrorMsg = field.NewString(table, "error_msg")
	l.Status = field.NewInt8(table, "status")
...
func (l *loginLog) fillFieldMap() {
	...
	l.fieldMap["des"] = l.Des
	l.fieldMap["os"] = l.Os
	l.fieldMap["browser"] = l.Browser
	l.fieldMap["error_msg"] = l.ErrorMsg
