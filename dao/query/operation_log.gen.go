...
func newOperationLog(db *gorm.DB, opts ...gen.DOOption) operationLog {
	...
	_operationLog.Type = field.NewString(tableName, "type")
	_operationLog.AccountID = field.NewInt64(tableName, "account_id")
	_operationLog.TenantID = field.NewInt32(tableName, "tenant_id")
	_operationLog.UID = field.NewInt64(tableName, "uid")
	...
	_operationLog.Address = field.NewString(tableName, "address")
	_operationLog.Des = field.NewString(tableName, "des")
	_operationLog.ReqHeaders = field.NewString(tableName, "req_headers")
	_operationLog.ReqBody = field.NewString(tableName, "req_body")
	_operationLog.RespHeaders = field.NewString(tableName, "resp_headers")
	_operationLog.RespBody = field.NewString(tableName, "resp_body")
	_operationLog.Latency = field.NewFloat64(tableName, "latency")
...
type operationLog struct {
	...
	ALL         field.Asterisk
	ID          field.Int32
	Type        field.String  // 类型:admin=admin后台（根据需要扩展）
	AccountID   field.Int64   // 添加用户id
	TenantID    field.Int32   // 租户唯一标识
	UID         field.Int64   // 用户id
	Method      field.String  // 请求方法
	URL         field.String  // 请求地址
	IP          field.String  // 登录IP
	Address     field.String  // 地点
	Des         field.String  // 登录行为
	ReqHeaders  field.String  // 请求头
	ReqBody     field.String  // 请求体
	RespHeaders field.String  // 响应头
	RespBody    field.String  // 响应体
	Latency     field.Float64 // 耗时
	Status      field.Int32   // 状态:0=成功,1=失败
...
func (o *operationLog) updateTableName(table string) *operationLog {
	...
	o.TenantID = field.NewInt32(table, "tenant_id")
	...
	o.Des = field.NewString(table, "des")
	o.ReqHeaders = field.NewString(table, "req_headers")
	o.ReqBody = field.NewString(table, "req_body")
	o.RespHeaders = field.NewString(table, "resp_headers")
	o.RespBody = field.NewString(table, "resp_body")
	o.Latency = field.NewFloat64(table, "latency")
...
func (o *operationLog) fillFieldMap() {
	...
	o.fieldMap["des"] = o.Des
	o.fieldMap["req_headers"] = o.ReqHeaders
	o.fieldMap["req_body"] = o.ReqBody
	o.fieldMap["resp_headers"] = o.RespHeaders
	o.fieldMap["resp_body"] = o.RespBody
