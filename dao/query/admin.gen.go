...
func newAdmin(db *gorm.DB, opts ...gen.DOOption) admin {
	...
	_admin.TenantID = field.NewInt32(tableName, "tenant_id")
	_admin.AccountID = field.NewInt64(tableName, "account_id")
	_admin.MainAccount = field.NewInt8(tableName, "main_account")
	_admin.DeptID = field.NewInt32(tableName, "dept_id")
	...
	_admin.Status = field.NewInt8(tableName, "status")
	_admin.Remark = field.NewString(tableName, "remark")
	_admin.Loginip = field.NewString(tableName, "loginip")
	_admin.Logintime = field.NewTime(tableName, "logintime")
	_admin.LoginAttempts = field.NewInt8(tableName, "login_attempts")
	_admin.LockTime = field.NewTime(tableName, "lock_time")
	_admin.PwdResetTime = field.NewTime(tableName, "pwd_reset_time")
...
type admin struct {
	...
	MainAccount   field.Int8   // 是否为租户主账号:0=否,1=是
	...
	Tel           field.String // 备用电话用户自己填写
	Status        field.Int8   // 状态:0=正常,1=禁用
	Remark        field.String // 备注
	Loginip       field.String // 登录IP
	Logintime     field.Time   // 最后登录时间
	LoginAttempts field.Int8   // 登录尝试次数
	LockTime      field.Time   // 账号锁定时间
	PwdResetTime  field.Time   // 修改密码时间
...
func (a *admin) updateTableName(table string) *admin {
	...
	a.MainAccount = field.NewInt8(table, "main_account")
	a.DeptID = field.NewInt32(table, "dept_id")
	...
	a.LoginAttempts = field.NewInt8(table, "login_attempts")
	a.LockTime = field.NewTime(table, "lock_time")
	a.PwdResetTime = field.NewTime(table, "pwd_reset_time")
...
func (a *admin) fillFieldMap() {
	...
	a.fieldMap["main_account"] = a.MainAccount
	...
	a.fieldMap["login_attempts"] = a.LoginAttempts
	a.fieldMap["lock_time"] = a.LockTime
	a.fieldMap["pwd_reset_time"] = a.PwdResetTime
