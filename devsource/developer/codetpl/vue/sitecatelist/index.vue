                ...
                <a-tree
                  ...
                  <template #extra="nodeData">
                    <span v-if="nodeData.key!=0" class="page-tree-tool" :class="{'page-tree-tool-active':nodeData.showbtn}">
                        <a-popover position="br" trigger="click" :popup-visible="nodeData.showbtn"  @popup-visible-change="(visible:any)=>nodeData.showbtn=visible">
                          <Icon class="unicon page-tree-menu-button" icon="svgfont-gengduo" :size="13"></Icon>
                          <template #content>
                            <div class="tigmenu">
                              <div class="item" @click="handleEditCate(nodeData)"><Icon class="bicon" icon="svgfont-edit-square" :size="13"></Icon> 编辑</div>
                              <div class="item delete" @click="handleDelCate(nodeData.id)"><Icon class="bicon" icon="svgfont-delete" :size="13"></Icon> 删除</div>
                            </div>
                          </template>
                        </a-popover>
                ...
                <div class="search-btn">
                 ...
                 <div class="search-option">
                  <tabletool :showbtn="['create','export','refresh','selectdensity','settingcolumn','fullscreen']" :columns="columns" :disabledColumnKeys="['id']"
                   @create="createData" @export="handleExportExcel" @refresh="fetchData" @selectdensity="(data:any)=>size=data" @fullscreen="(data:any)=>isFullscreen=data" @settingcolumn="(data:any)=>cloneColumns=data"></tabletool>
                </div>
              </div>
...
<script lang="ts" setup>
  ...
  import { cateList,delCate} from './api/cate';
